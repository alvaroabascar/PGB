...
png('GO/quesito_all.png', height=6, width=6, units='in', res=80)
par(mar=c(4,4,5,4))
pie(all$perc[1:num_classes], labels=all$class[1:num_classes])
dev.off()

png('GO/quesito_hk.png', height=6, width=6, units='in', res=80)
par(mar=c(2,2,2,10))
pie(hk$perc[1:num_classes], labels=hk$class[1:num_classes])
dev.off()

png('GO/quesito_ts.png', height=6, width=6, units='in', res=80)
par(mar=c(4,4,5,4))
